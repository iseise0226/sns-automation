...
const PASONA_STRUCTURE = `台本はナレーション${SCENE_COUNT}シーン分。各シーン25〜35文字(全体で合計350文字程度・約1分の動画になる)で、以下の流れに沿って一つのストーリーとして繋がるように書いてください。1シーン1メッセージで、テンポよく言い切ってください。
...
文章のトーン：機械的な説明文ではなく、寄り添うように、優しく、押しつけがましくならないように話し言葉で書いてください。断定しすぎず「〜かもしれません」「〜してみませんか」のような柔らかい語尾を使ってください。テンプレート的な決まり文句の繰り返しを避け、毎回具体的で新鮮な表現を心がけること。`;
