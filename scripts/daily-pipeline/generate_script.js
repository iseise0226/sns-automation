...
2. {"type":"points","title":"シーン見出し(12字以内)","layout":"stack"|"panels"|"row"|"compare","beats":[3個、各{"kind":"bubble"|"box"|"check"|"cross","text":"短いフレーズ\\n改行可(**強調**可、10〜16文字程度)","sub":"読み上げ文(40〜70文字)"}]}
   - layout="compare"のときはbeatsは2個ちょうど
   - kindは、layout="compare"なら1個目box/2個目box、"stack"ではbubble中心、良い話ならcheck、NG例ならcrossを使う
...
- layoutは同じものを連続させない。stack/panels/row/compareを散らす
