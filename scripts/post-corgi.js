...
async function generateImageBase64(sceneText) {
  const prompt =
    'かわいいウェルシュコーギーの子犬の水彩イラスト。デフォルメされたゆるいタッチで、頭が大きく体が小さいプロポーション。' +
    '大きく丸い緑色の瞳に光が入っていて潤んだ目、毛は白とオレンジ・タン色の2色、耳は大きく立った三角形、舌を少し出した笑顔の表情。' +
    '背景は淡いパステルカラー（薄緑・薄水色・クリーム色）のにじみで、輪郭はやわらかい白い縁取り。子供向け絵本のような優しく温かみのある雰囲気。' +
    `次のシーンに合わせたポーズ・表情で描く: ${sceneText}。`;
  const body = JSON.stringify({
    model: 'gpt-image-1',
    prompt,
    size: '1024x1024',
